...
* The GeographicCoordinateImpl class has been renamed to AbstractGeographicCoordinate.  Also new in this release, extending the class is disallowed and is enforced by throwing an exception from its constructors.  This is not a client class.  No one should be affected by this, since client code would have been working with the Latitude and Longitude classes only.
